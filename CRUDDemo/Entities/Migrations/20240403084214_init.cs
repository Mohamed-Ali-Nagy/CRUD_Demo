        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    //table.ForeignKey(
                    //    name: "FK_Countries_Countries_CountryId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiveNewsLetters = table.Column<bool>(type: "bit", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "CountryId", /*"CountryId1",*/ "CountryName" },
                values: new object[,]
                {
